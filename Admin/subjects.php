...
<?php  
	if (isset($_POST['sub'])) {
		...
		$scheme = $_POST['scheme'];
		$query="insert into course_subjects(subject_code,subject_name,course_code,semester,scheme)values('$subject_code','$subject_name','$course_code','$semester','$scheme')";
					...
					<div class="col-md-12 ml-2">
						<section class="mt-3">
							<table class="w-100 table-elements table-three-tr" cellpadding="3">
								...
								<?php
									$sr=1;
									$query="select subject_code,subject_name,course_code,semester,scheme from course_subjects";
									$run=mysqli_query($con,$query);
									while($row=mysqli_fetch_array($run)) {
									echo	"<tr>";
									echo	"<td>".$sr++."</td>";
